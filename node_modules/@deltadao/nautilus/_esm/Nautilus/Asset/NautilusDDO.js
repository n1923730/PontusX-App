...
import { combineArraysAndReplaceItems, dateToStringNoMS, getAllPromisesOnArray, removeDuplicatesFromArray } from '../../utils';
...
export class NautilusDDO {
    ...
    async buildDDOServices() {
        ...
        const servicesWithEncryptedFiles = await getAllPromisesOnArray(this.services, async (service) => {
    ...
    async getDDOServices() {
        ...
        if (this.services.length > 0) {
            replacedServices = combineArraysAndReplaceItems(reducedExistingServices, newServices, NautilusDDO.replaceServiceBasedOnId);
        }
