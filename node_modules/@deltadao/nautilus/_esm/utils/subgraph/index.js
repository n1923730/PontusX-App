...
let client;
export function getQueryContext(subgraphUri) {
    try {
        const queryContext = {
...
export async function fetchData(subgraphUri, query, 
...
export function getAccessDetailsFromTokenPrice(tokenPrice, timeout) {
    const accessDetails = {};
