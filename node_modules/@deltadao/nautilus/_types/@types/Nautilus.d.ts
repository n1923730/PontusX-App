import type { Asset, ConsumerParameter, Metadata, PublisherTrustedAlgorithm } from '@oceanprotocol/lib';
import type { NautilusAsset } from '../Nautilus/Asset/NautilusAsset';
import type { FileTypes, NautilusService, ServiceFileType, ServiceTypes } from '../Nautilus/Asset/Service/NautilusService';
import type { DatatokenCreateParamsWithoutOwner, NftCreateDataWithoutOwner, PricingConfig } from './Publish';
...
export declare enum CredentialListTypes {
    ALLOW = "allow",
    DENY = "deny"
}
...
export interface IServiceBuilder<S extends ServiceTypes, F extends FileTypes> extends IBuilder<NautilusService<S, F>> {
